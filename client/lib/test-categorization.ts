/**
 * Strict Test Categorization Utility
 * 
 * This utility provides a single source of truth for categorizing tests
 * across the application. It ensures tests are placed in the correct
 ...
 */
export function groupTestsByCategory(tests: TestInfo[]): Record<TestCategory, TestInfo[]> {
