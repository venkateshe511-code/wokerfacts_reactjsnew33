...
<h3 style="font-weight: bold; margin-bottom: 8px; font-family: Arial, sans-serif;">General Patterns of Activity Descriptors</h3>
  ...
  <h3 style="font-weight: bold; margin-bottom: 5px; font-family: Arial, sans-serif;">Dynamic Lift Test End Point Conditions</h3>
    ...
    <div style="page-break-before: always; padding: 40px 0;">
        <div class="section">
            <h3 style="font-weight: bold; margin-bottom: 8px; font-family: Arial, sans-serif;">Appendix One-A: Sensitivity and Specificity of the Blankenship FCE System</h3>
            <p style="font-size: 10px; color: #666; margin-bottom: 20px; font-family: Arial, sans-serif;">Source: Penny N Brubaker, PT, MSI; Frank J Fearon, PT, DHSc, OCS, FAACGPT2; Stephen M Smith, PhD; Richard J. Bohannon, PT, MS, ECS4; James Alday, MDS; Sheryl S Andrew, PT, MS6; Everald Clarke, PT, MS7; George L Shaw Jr, PT, MS8</p>
